...
- 선택한 글자를 한자키로 전환기능 사용시 글자전환 글자를 표시함
...
3. 유사한 문자를 직관적인 위치로 문자를 재배치함.
   Below_dot 글자를 영어글자 기본 위치에 배치하고, above_dot 또는 macro 글자를 해당 영어글자 위치에 배치.

5. 한자키와 영어 문자를 동시 입력하여 Pali어 문자를 입력함.
